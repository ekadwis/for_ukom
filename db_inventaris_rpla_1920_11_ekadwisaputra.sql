...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2021 at 11:44 PM
...
('BRG10002', 'Kursi lipat siswa', 'Kursi lipatmerek InformaBantalan', 'R002', 'Baik', 36, 'S001', '1636928500_90a20756a170c31bc56a.png'),
('BRG20001', 'Laptop Acer Aspire E1-471', 'Core i3 Ram 4GBHDD 500GB', 'R002', 'Baik', 30, 'S002', '1636928520_fd22ca04b99d36d7cd86.png'),
('BRG20002', 'Laptop Lenovo E550', 'Laptop Lenovo E550intel Core i7Ram 8GBHDD 1TB', 'R002', 'Baik', 23, 'S003', '1636928628_14a7607708c455ba293e.jpg'),
('BRG20003', 'PC Rakitan i7', 'Intel Core i7Ram 16GBSSD 512GB', 'R001', 'Baik', 12, 'S004', '1636928686_56a49f4cb45aaabdbff6.jpg'),
('BRG20004', 'Camera DSLR D60', 'Spek high end ', 'R005', 'Baik', 16, 'S003', '1636928772_dc203d5e46ff7d9cec96.jpg'),
('BRG30001', 'Lightning set', 'Spek High end', 'R005', 'Baik', 2, 'S005', '1636928854_73be1925c855b67f428c.jpg'),
('BRG30002', 'Tripod Kamera', 'Takara tripod', 'R005', 'Baik', 4, 'S002', '1636928461_96794dc717607def8e1a.jpg'),
('BRG30003', 'Earphone', 'Earphone ROG Gen 3', 'R001', 'Baik', 5, 'S001', '1636928944_cf9c3a6c1e4291b87190.jpg'),
('BRG30004', 'Handphone ', 'Samsung XX12 dengan teknologi terbaru', 'R001', 'Baik', 52, 'S001', '1636928905_3d6c18aebbcfe63bc249.jpg'),
('BRG30005', 'Camera Canon', 'Keren', 'R001', 'Baik', 5, 'S001', '1636928934_256d8d58aeb3abe79a4e.png'),
('BRG30008', 'qdqd', '2e1e', 'R001', 'Baik', 10, 'S001', '1636899358_4cc6c0a780d7d556771f.png');
...
DECLARE jml_keluars INT; 
DECLARE supp CHAR(8) DEFAULT 'SPR001'; 

SELECT supplier INTO supp FROM barang_masuk WHERE id_barang = OLD.id_barang;

SET jml_keluars = OLD.jumlah_barang - NEW.jumlah_barang;

UPDATE barang_keluar
SET jml_keluar=jml_keluars, supplier=supp WHERE id_barang = NEW.id_barang;
...
('BRG20001', '2017-11-06', 0, 'SPR004'),
('BRG30008', '2021-11-14', 5, 'SPR001');
...
--
-- Table structure for table `list_databarang`
--

CREATE TABLE `list_databarang` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `list_databarang`
--

INSERT INTO `list_databarang` (`id`, `nama_table`, `slug`, `image`) VALUES
(1, 'Barang', 'barang', 'barang.jpg'),
(2, 'Barang Masuk', 'barang-masuk', 'barang-masuk.png'),
(3, 'Barang Keluar', 'barang-keluar', 'barang-keluar.png'),
(4, 'Stok', 'stok', 'stok.png'),
(5, 'Pinjam Barang', 'pinjam-barang', 'pinjam-barang.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `list_datauser`
--

CREATE TABLE `list_datauser` (
  `id` int(11) NOT NULL,
  `nama_table` varchar(255) NOT NULL,
  `image` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `list_datauser`
--

INSERT INTO `list_datauser` (`id`, `nama_table`, `image`) VALUES
(1, 'User', ''),
(2, 'Level User', ''),
(3, 'Supplier', ''),
(4, 'Sumber Dana', ''),
...
--
-- Indexes for table `list_databarang`
--
ALTER TABLE `list_databarang`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `list_datauser`
--
ALTER TABLE `list_datauser`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `list_databarang`
--
ALTER TABLE `list_databarang`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `list_datauser`
--
ALTER TABLE `list_datauser`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
